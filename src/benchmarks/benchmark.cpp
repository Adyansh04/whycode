...
struct Cache
{
    ...
    void print() const
    {
        std::cout << "sum_x=" << sum_x << ", sum_y=" << sum_y << ", sum_xx=" << sum_xx
                  << ", sum_xy=" << sum_xy << ", sum_yy=" << sum_yy << std::endl;
    }
};
...
void compute_stats_simd_aligned(
    const aligned_vector<int>& queue, int start, int end, int width, Cache& cache)
{
    // Reset accumulators
...
void compute_stats_simd_optimized(
    const std::vector<int>& queue, int start, int end, int width, Cache& cache)
{
...
void compute_stats_simd_optimized_aligned(
    const aligned_vector<int>& queue, int start, int end, int width, Cache& cache)
{
    // Reset pre-allocated SIMD vectors
...
double benchmark_function(
    const std::string& name, Func&& func, const QueueType& queue, int start, int end, int width,
    int iterations = 1000)
{
    Cache    cache;
...
int main()
{
    ...
    double simd_aligned_time = benchmark_function(
        "SIMD Implementation (Aligned)",
        compute_stats_simd_aligned,
        aligned_queue,
        0,
        test_size,
        width,
    ...
    double simd_opt_time = benchmark_function(
        "SIMD Optimized Implementation (Unaligned)",
        compute_stats_simd_optimized,
        queue,
        0,
        test_size,
        width,
    ...
    double simd_opt_aligned_time = benchmark_function(
        "SIMD Optimized Implementation (Aligned)",
        compute_stats_simd_optimized_aligned,
        aligned_queue,
        0,
        test_size,
        width,
    ...
    std::cout << "  Speedup: " << std::fixed << std::setprecision(2) << speedup_simd << "x"
              << std::endl;
    std::cout << "  Improvement: " << std::fixed << std::setprecision(1) << improvement_simd << "%"
              << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  Speedup: " << std::fixed << std::setprecision(2) << speedup_aligned << "x"
              << std::endl;
    std::cout << "  Improvement: " << std::fixed << std::setprecision(1) << improvement_aligned
              << "%" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  Speedup: " << std::fixed << std::setprecision(2) << speedup_align_vs_unalign
              << "x" << std::endl;
    std::cout << "  Improvement: " << std::fixed << std::setprecision(1)
              << improvement_align_vs_unalign << "%" << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  Speedup: " << std::fixed << std::setprecision(2) << speedup_opt << "x"
              << std::endl;
    std::cout << "  Improvement: " << std::fixed << std::setprecision(1) << improvement_opt << "%"
              << std::endl;
    std::cout << std::endl;
    ...
    std::cout << "  Speedup: " << std::fixed << std::setprecision(2) << speedup_opt_aligned << "x"
              << std::endl;
    std::cout << "  Improvement: " << std::fixed << std::setprecision(1) << improvement_opt_aligned
              << "%" << std::endl;
    std::cout << std::endl;

    // Optimized Unaligned vs Aligned
    double speedup_opt_align_vs_unalign = simd_opt_time / simd_opt_aligned_time;
    double improvement_opt_align_vs_unalign =
        ((simd_opt_time - simd_opt_aligned_time) / simd_opt_time) * 100.0;
    std::cout << "SIMD Optimized (Unaligned) vs SIMD Optimized (Aligned):" << std::endl;
    std::cout << "  Speedup: " << std::fixed << std::setprecision(2) << speedup_opt_align_vs_unalign
              << "x" << std::endl;
    std::cout << "  Improvement: " << std::fixed << std::setprecision(1)
              << improvement_opt_align_vs_unalign << "%" << std::endl;
