...
whycon::MultiMarkerDetector::MultiMarkerDetector(int _number_of_circles, int _width, int _height,
...
bool whycon::MultiMarkerDetector::detectMarkers(ImageHandler& image_handler, bool reset,
    ...
    for (int i = 0; i < number_of_circles; i++) {
        ...
        detectors[i].detectMarkerPair(image_handler, is_fast_cleanup_possible, marker_pair_result_, circles[i],
                                      debug_manager);
