...
class TwoMarkerWhyCodeTriangulationNode {
  public:
    struct MarkerData {
    ...
    struct TriangulationConfig {
        ...
        std::string target_frame                   = "whycode_marker_center";
        ...
        std::string camera_odom_parent_frame = "whycode_marker_center";
    ...
    // Constructor
    explicit TwoMarkerWhyCodeTriangulationNode(ros::NodeHandle& nh, ros::NodeHandle& private_nh);
...
#endif  // TWO_MARKER_WHYCODE_TRIANGULATION_HPP
