...
public:
     ...
     */
    MarkerTracker(
        int max_frames_unseen, double max_association_dist, int min_track_age, int max_tracks = 25);
     ...
     * @param removed_ids Output vector that will be cleared and filled with the tracking_ids that
     * were removed.
     */
    void update(
